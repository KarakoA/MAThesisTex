...
\lstdefinestyle{html}{
    numberblanklines=false,
    language=HTML, basicstyle=\fontsize{9}{9}\selectfont\ttfamily
}
...
\lstdefinelanguage{JavaScript}{
  keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break,interface,type,enum,class},
...
\lstdefinelanguage{JavaScriptPlain}{
  keywordstyle=\color{blue}\bfseries,
  ndkeywordstyle=\color{darkgreen}\bfseries,
  identifierstyle=\color{black},
  sensitive=false,
