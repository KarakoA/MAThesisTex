...
The generation of the interaction diagram graph from the result class from \ref{impl:result} is done in the \code{transformer.ts} class. 
As the underlying structure for the graph   
